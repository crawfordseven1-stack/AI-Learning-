    ...
    case 'Brain':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
          <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.98-1.57A3.5 3.5 0 0 1 5.55 15H5a2.5 2.5 0 0 1 0-5h.55a3.5 3.5 0 0 1 1.48-2.87A2.5 2.5 0 0 1 9.5 5H12a2.5 2.5 0 0 1 0-5h-.5Z" /><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.98-1.57A3.5 3.5 0 0 0 18.45 15H19a2.5 2.5 0 0 0 0-5h-.55a3.5 3.5 0 0 0-1.48-2.87A2.5 2.5 0 0 0 14.5 5H12a2.5 2.5 0 0 0 0-5h.5Z" />
        </svg>
      );
    case 'Eye':
      return (
